...
namespace Morpheus {
	...
	public:
		...
		// bTight: Whether or not to make the compression tight, if set to true, 
		// any additional alloc will require a resize.
		...
		// h: Handle to the object to free
